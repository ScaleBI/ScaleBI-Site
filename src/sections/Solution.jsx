    ...
    return (
        <section className="w-full bg-[#FFFFFF] flex justify-center">
            <div className=" w-full max-w-[1440px] flex flex-col items-center p-[40px] sm:p-[80px] gap-[32px] sm:gap-[64px] px-[16px] sm:px-[80px]">
                ...
                {/* Button */}
                <button className="flex gap-2 bg-gradient-to-b from-[#FFFFFF] to-[#E0E5FF]  w-[250px] sm:w-auto border border-[#504DFF] rounded-[12px] py-[10px] px-[16px] justify-center items-center">
